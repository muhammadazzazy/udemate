...
- [x] Delete the user data directory before the non-headless browser starts and ask the user whether they logged in to Udemy before automating course enrollment
